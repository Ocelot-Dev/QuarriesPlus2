...
import ocelot.mods.qp2.PacketHandler;
import ocelot.mods.qp2.TilePumpPlus;
...
public class GuiP_List extends GuiScreenA {
	...
	private TilePumpPlus tile;
	byte dir;

	public GuiP_List(byte id, TilePumpPlus tq) {
		super(null);
		this.dir = id;
		this.tile = tq;
	}
	...
	public void drawScreen(int i, int j, float k) {
		...
		this.drawCenteredString(
				...
				StatCollector.translateToLocal("pp.list.setting")
						+ StatCollector.translateToLocal(TilePumpPlus.fdToString(ForgeDirection.getOrientation(this.dir))), this.width / 2, 8, 0xFFFFFF);
