...
public class EntityMechanicalArm extends Entity {
	...
	protected TileQuarryPlus parent;
	...
	public EntityMechanicalArm(World world, double i, double j, double k, double width, double height, TileQuarryPlus tileQuarryPlus) {
		this(world);
		setPositionAndRotation(tileQuarryPlus.xCoord, tileQuarryPlus.yCoord, tileQuarryPlus.zCoord, 0, 0);
		this.xRoot = i;
		this.yRoot = j;
		this.zRoot = k;
		this.motionX = 0.0;
		...
		this.parent = tileQuarryPlus;
		tileQuarryPlus.setArm(this);
		updatePosition();
	}
	...
	private void findAndJoinQuarry() {
		...
		if (te != null && te instanceof TileQuarryPlus) {
			this.parent = (TileQuarryPlus) te;
