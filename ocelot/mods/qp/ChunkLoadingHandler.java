...
public class ChunkLoadingHandler implements ForgeChunkManager.OrderedLoadingCallback {
	...
	public void ticketsLoaded(List<Ticket> tickets, World world) {
		for (Ticket ticket : tickets) {
			...
			if (te instanceof TileQuarryPlus) ((TileQuarryPlus) te).forceChunkLoading(ticket);
			else if (te instanceof TileMarkerPlus) ((TileMarkerPlus) te).forceChunkLoading(ticket);
		}
	}
	...
	public List<Ticket> ticketsLoaded(List<Ticket> tickets, World world, int maxTicketCount) {
		...
		for (Ticket ticket : tickets) {
			...
			if (blId == QuarryPlus2.blockQuarry.blockID || blId == QuarryPlus2.blockMarker.blockID) {
