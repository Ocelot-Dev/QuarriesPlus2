/*
 * Copyright (C) 2012,2013 yogpstop This program is free software: you can
...
@Mod(modid = "qp2", name = "QuarryPlus2", version = "@VERSION@", dependencies = "required-after:BuildCraft|Builders;required-after:BuildCraft|Core;required-after:BuildCraft|Energy;required-after:BuildCraft|Factory;required-after:BuildCraft|Silicon;required-after:BuildCraft|Transport")
...
{
	@SidedProxy(clientSide = "ocelot.mods.qp.client.ClientProxy", serverSide = "ocelot.mods.qp.CommonProxy")
	...
	public void init(FMLInitializationEvent event)
	{
		...
		GameRegistry.registerTileEntity(TileQuarryPlus.class, "QuarryPlusPlus");
		GameRegistry.registerTileEntity(TileMarkerPlus.class, "MarkerPlusPlus");
