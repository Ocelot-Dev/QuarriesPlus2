...
public class BlockPlacer extends BlockContainerBase {
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister.registerIcon("qp2:plusstone_side");
		this.furnaceTopIcon = par1IconRegister.registerIcon("qp2:plusstone_top");
		this.horizontal = par1IconRegister.registerIcon("qp2:placer_front_horizontal");
		this.vectrial = par1IconRegister.registerIcon("qp2:placer_front_vertical");
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer ep, int par6, float par7, float par8, float par9) {
		...
		if (!world.isRemote) ep.openGui(QuarryPlus2.instance, QuarryPlus2.guiIdPlacer, world, x, y, z);
		return true;
	}
}
