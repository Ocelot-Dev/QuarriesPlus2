...
public class BlockLaserPlus extends BlockContainerBase {

	@SideOnly(Side.CLIENT)
	private Icon textureTop, textureBottom;

	public BlockLaserPlus(int i) {
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.textureTop = par1IconRegister.registerIcon("qp2:laser_top");
		this.textureBottom = par1IconRegister.registerIcon("qp2:laser_bottom");
		this.blockIcon = par1IconRegister.registerIcon("qp2:laser_side");
	}
	...
	public void breakBlock(World world, int x, int y, int z, int id, int meta) {
		TileLaserPlus tile = (TileLaserPlus) world.getBlockTileEntity(x, y, z);
		this.drop.clear();
