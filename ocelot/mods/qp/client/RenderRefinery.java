...
import ocelot.mods.qp.TileRefineryPlus;
...
public class RenderRefinery extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler {
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation("qp2", "textures/blocks/refinery.png");
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
		render((TileRefineryPlus) tileentity, x, y, z);
	}
