...
public class ItemTool extends ItemBase implements IEnchantableItem {
	Icon ile, ils;
	...
	public void registerIcons(IconRegister ir) {
		this.itemIcon = ir.registerIcon("qp2:statusChecker");
		this.ile = ir.registerIcon("qp2:listEditor");
		this.ils = ir.registerIcon("qp2:liquidSelector");
	}
